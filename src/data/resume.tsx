  ...
  work: [
    {
      ...
      tagline:
        "Voice interview agent, agent harness, MCP / CLI layer, recruit — from zero.",
      description:
    ...
    },
    {
      ...
      tagline:
        "Part-time co-founder — RAG enterprise bot in Python + LlamaIndex.",
      description:
    ...
    },
    {
      ...
      tagline:
        "Backend & AI consulting — RAG PoC (90%+ accuracy), streaming platform.",
      description:
